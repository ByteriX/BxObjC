...
@property (nonatomic, assign) id <JCMSegmentPageControllerDelegate> delegate;

@property (nonatomic, readonly) UIView * headerContainerView;
@property (nonatomic, readonly) UIView * contentContainerView;
@property (nonatomic, readonly) UISegmentedControl * segmentedControl;

@property (nonatomic, assign) BOOL splitAllControllers;
